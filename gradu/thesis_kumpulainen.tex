% This ensures that the metadata is PDF/A compliant
\begin{filecontents*}[overwrite]{\jobname.xmpdata}
  \Title{Artificial General Intelligence - a systematic mapping study}
  \Author{Samu Kumpulainen}
  \Language{en}
  \Subject{The research field of artificial general intelligence is growing more popular
  ...
  findings show small but steady amount of research being published yearly,
  ...
  \Keywords{AGI\sep AI\sep artificial intelligence\sep artificial general intelligence\sep systematic literature mapping\sep mapping study}
\end{filecontents*}
...
% Hyperref package comes from pdfx
\hypersetup{bookmarksopen,bookmarksnumbered,linktocpage}

\restylefloat{table}

\addbibresource{thesisReferences.bib} % The file name of your bibliography database

% Required for the bubble plots
\pgfplotsset{
...
\translatedtitle{Yleinen tekoäly - systemaattinen kirjallisuuskartoitus}
...
nykyisestä tutkimuksesta. Tutkielmassa käytiin läpi 92 artikkelia viidestä eri
...
tekoälyn laskettavuuden teoria, tekoälyn turvallisuutta ja
etiikkaa koskevat kysymykset, sekä erilaiset oppimismenetelmät. Suurin osa
yleisen tekoälyn tutkimuksesta tulee Euroopan maista, mutta julkaisumäärältään
...
As the AGI community is diverse and there are a multitude of opinions on the
