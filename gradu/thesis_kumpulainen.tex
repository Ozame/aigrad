...
then combined together to achieve a more general set of concepts. On some cases
having a more detailed inspection of the article might be required
...
one reflecting the research approach can be used. One example of the latter is
...
Check (\cite{kitchemham2007}), and (\cite{kitchenham2010})
