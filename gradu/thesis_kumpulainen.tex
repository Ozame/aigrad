...
process, and to quickly inspect topics, classes, and other article metadata. All
the text and source files of this thesis were stored in a git repository in
Github.
