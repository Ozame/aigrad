...
\begin{figure}[h]
  \includegraphics[scale=0.75]{material/data/forum_pie.png}
...
\begin{table}[H]
  ...
  \begin{tabular}{p{0.05\linewidth} p{0.30\linewidth} p{0.65\linewidth}}
    ...
    18 & Philosophical aspects & Philosophical questions relating to general agents, e.g. AI ethics and morality.\\ \hline
...
decision makes some graphs slightly less accurate, provides it information on
which topics and what kinds of papers are usually seen together. The results of
this mapping process are presented in the following chapter.
