...
Suprisingly there were few opinion articles found. AND???
...
still focused more on the theoretical side. TODO: refactor this.


- More evaluation research is needed! is the lack because of
lack of practical applications? time to take sps to test!
...
Here some text about the countries that publish agi research. The table with
countries and no of papers should be in the appendix (with ms). Here the map should be present.
