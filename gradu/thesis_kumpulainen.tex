...
Reinforcement learning (RL) is the third largest category with 11 articles
...
Experiential or cumulative learning means that an agent utilizes it's previous
...
Many papers with philosophical topics such as \textbf{AI safety} and
\textbf{Philosophical aspects} could be found in the study, both prevalent in 11
papers. Especially AI safety, which concerns...
...
Here's something about the short time trends that can be seen from graphs.
...
% Types explained a bit more and observations made from the bubble plot.
% It is very important to describe the focus and gaps here! RQ1
...
\section{TODO: Where to put this: Validity threats?}
...
\section{TODO: Where to put this: Possible continuation research}
