...
Here some text about the countries that publish agi research. Put the map to the
appendix? At least the table with countries and no of papers should be in the appendix (with ms)
